    ...
    >
      <div className="max-w-5xl mx-auto flex flex-col items-center gap-6 text-center">
        <div>
          ...
          <a
            href="mailto:jim.carrey@example.com"
            className="text-gray-400 hover:text-indigo-400 transition-colors text-base sm:text-lg"
          >
            jim.carrey@example.com
          </a>
        </div>
        ...
        <p className="text-gray-600 text-xs mt-4">
          &copy; {new Date().getFullYear()} Jim Carrey. All rights reserved.
        </p>
      </div>
    </footer>
  );
